                            ...
                            <div className="report-content header-orange">
                                <div className='section-header' >
                                    ...
                                    <div className={
                                        ...
                                        {reportView === 'aging' ? ' HYDRANTS AGING ANALYSIS (OTS PENDING ORDERS - Current Month)' :
                                            reportView === 'summary' ? ' HYDRANTS DAILY ORDER SUMMARY (Created Today)' : ' HYDARNTS DAILY GALLONS SUMMARY (Created, Dispatched & Completed Today)'}
                                    </div>
